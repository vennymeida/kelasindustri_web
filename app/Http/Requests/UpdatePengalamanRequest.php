...
class UpdatePengalamanRequest extends FormRequest
{
    ...
    {
        return [
            'nama_pengalaman.required' => 'Nama Pekerjaan Tidak Boleh Kosong',
            'nama_pengalaman.max' => 'Inputan Nama Pekerjaan Melebihi Batas Maksimal',
            'nama_instansi.required' => 'Nama Perusahaan Tidak Boleh Kosong',
            'nama_instansi.max' => 'Inputan Nama Perusahaan Melebihi Batas Maksimal',
