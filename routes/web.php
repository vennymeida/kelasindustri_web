...
Route::get('/all-jobs/{lokers:slug}', [AlljobsController::class, 'detail_rekomendasi'])->name('all-jobs.detail_rekomendasi');
Route::get('/all-postingan', [AllPostinganController::class, 'index'])->name('all-postingan.index');
Route::get('/detail-perusahaan/{lokers:slug}', [AlljobsController::class, 'show'])->name('detail-perusahaan.show');
