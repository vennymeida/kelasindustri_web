                                        ...
                                        <div class="card col-md-6 mb-4">
                                            <div class="card-body d-flex flex-column">
                                                <div class="position-relative">
                                                    ...
                                                    <p class="ml-2">pekerjaan cocok dengan mu {{ $loker->name }}</p>
                                                ...
                                                <div class="text-center">
                                                    <a id="detail-button" class="btn btn-primary px-4 py-2"
                                                        style="border-radius: 25px;" h
                                                        href="{{ route('all-jobs.detail_rekomendasi', $loker->slug) }}">Lihat
                                                        Detail</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="text-center">
                                                    <a id="detail-button" class="btn btn-primary px-4 py-2"
                                                        ...
                                                        href="{{ route('detail-perusahaan.show', $loker->slug) }}">Lihat
                                                        Detail</a>
                                                </div>
                                            </div>
                                        </div>
