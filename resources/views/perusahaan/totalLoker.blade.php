            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary" style="border-radius: 15px;">
                        ...
                        <div class="card-body">
                            {{-- <form action="{{ route('showLoker', $perusahaan->id) }}" method="GET">
                                <div class="form-row text-center">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <a href="{{ route('showLoker', $perusahaan->id) }}" class="btn btn-secondary ml-2">Reset</a>
                                    </div>
                                </div>
                            </form> --}}
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        ...
                                        @else
                                            @foreach ($lowonganPekerjaan as $key => $loker)
                                                <tr>
                                                    <td>
                                                        {{ ($lowonganPekerjaan->currentPage() - 1) * $lowonganPekerjaan->perPage() + $key + 1 }}
                                                    </td>
